...
class ProfilePage extends StatelessWidget {
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("nikelmaharjan@gmail.com", style: TextStyle(fontSize: 14, color: Colors.black),)
                  ],
                ),
              ),
            ),
        ...
        child: Column(
          ...
          children: [
            Container(
                ...
                child: Text(header, style: TextStyle(fontSize: 18, color: black, fontWeight: FontWeight.bold),)),
            ListTile(
  ...
  Text _buildText(String title) => Text(title, style: TextStyle(color: lightBlack, fontWeight: FontWeight.w600),);
}
